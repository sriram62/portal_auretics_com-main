...
$(document).ready(function() {
    ...
    $('body').append('' +
        ...
        '</div>' +
        '</div>' +
        '<a href="http://html.codedthemes.com/mash-able/bootstrap/doc/index.html" target="_blank" class="btn btn-primary btn-block m-r-15 m-t-20 m-b-10 ">Online Documentation</a>' +
