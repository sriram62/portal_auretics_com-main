...
$(document).ready(function() {
    setTimeout(function() {
        ...
        Morris.Bar({
            ...
            barColors: ["#0073aa", "#536dfe", "#2ecc71"]
        });
        ...
        Morris.Bar({
            ...
            ykeys: ['a', 'b', 'c'],
            labels: ['Bar 1', 'Bar 2', 'Bar 3'],
            barColors: ["#f1c40f", "#e74c3c", "#0073aa"]
        });
        ...
        Morris.Area({
            ...
            lineColors: ['#2ecc71', '#536dfe', '#0073aa'],
            xkey: 'period',
        ...
        var graph_real = Morris.Line({
            ...
            ymin: -1.0,
            ymax: 1.0,
            lineColors: ['#f1c40f', '#e74c3c', '#0073aa'],
            pointSize: 4,
            responsive: true,
            pointFillColors: ['#fff', '#fff', '#fff'],
            pointStrokeColors: ['#f1c40f', '#e74c3c', '#0073aa'],
            lineWidth: 2,
            hideHover: true
        });
