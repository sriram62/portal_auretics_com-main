    ...
    setTimeout(function() {
        ...
        $(function() {
            var options = {
                ...
                colors: ["#0073aa", "#0e9e4a", "#f1c40f", "#e74c3c"],
                responsive: [{
                    breakpoint: 480,
                    options: {
                        legend: {
        ...
        $(function() {
            var options = {
                ...
                colors: ["#0073aa", "#00acc1", "#0e9e4a", "#f1c40f", "#e74c3c"],
                stroke: {
                    width: 1,
                    colors: ['#fff']
                },
        ...
        $(function() {
            var options = {
                ...
                colors: ["#0073aa", "#0e9e4a", "#e74c3c", "#f1c40f", "#00acc1"],
                series: [{
                    name: "SAMPLE A",
                    data: [
                        [16.4, 5.4],
